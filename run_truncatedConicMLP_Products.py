...
trun_names = ["truncated_model_1","truncated_model_3"]
...
model_names = ["model_2","model_3","model_4"]
        ...
        for trun_n in trun_names:
            ...
            for coeff in coeff_list:
                ...
                for embed in embedding_list:
                    ...
                    graph.dir = root_dir
                    eigenVec, lambdaVal, runTime = truncated_spectral_embedding(G=graph, root_dir=root_dir, dataset_name=ds, dim=coeff*graph.num_classes, iter=trun_params[trun_n], amb_dim=None,use_cache=True)
