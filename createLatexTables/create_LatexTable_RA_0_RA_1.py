...
model_name = ["conicMLP_model_0","conicMLP_model_1"]

different_model_names = ["Radial$_{1-norm}$","Radial$_{2,2}$"]
...
for per_name in performance_names:
    for embed in embedding_list:
        with open(f"{root_dir}/Latex_Tables/{per_name}_allDS_{embed}_RA_0_RA_1.tex", "w") as latex_table:
