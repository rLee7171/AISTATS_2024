...
model_name = ["conicMLP_model_1","spectrumMLP"]

different_model_names = ["Radial$_{2,2}$", "MLP"]
...
for per_name in performance_names:
    for embed in embedding_list:
        with open(f"{root_dir}/Latex_Tables/{per_name}_allDS_{embed}_MLP_RA_1.tex", "w") as latex_table:
